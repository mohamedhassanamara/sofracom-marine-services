...
const TRANSLATIONS = {
    en: {
        ...
        'products.controls.allBrands': 'All brands',
        'products.controls.searchPlaceholder': 'Search products...',
        'products.controls.sortNameAsc': 'Name: A to Z',
        'products.controls.sortNameDesc': 'Name: Z to A',
        'products.controls.sortPriceAsc': 'Price: low to high',
        'products.controls.sortPriceDesc': 'Price: high to low',
        'products.controls.reset': 'Reset controls',
    },
    fr: {
        'nav.home': 'Accueil',
        'nav.about': 'À propos',
        ...
        'products.controls.allBrands': 'Toutes les marques',
        'products.controls.searchPlaceholder': 'Rechercher des produits...',
        'products.controls.sortNameAsc': 'Nom : A à Z',
        'products.controls.sortNameDesc': 'Nom : Z à A',
        'products.controls.sortPriceAsc': 'Prix : du moins cher au plus cher',
        'products.controls.sortPriceDesc': 'Prix : du plus cher au moins cher',
        'products.controls.reset': 'Reinitialiser les controles',
    },
    ar: {
        'nav.home': 'الرئيسية',
        'nav.about': 'من نحن',
        ...
        'products.controls.allBrands': 'كل العلامات',
        'products.controls.searchPlaceholder': 'ابحث عن المنتجات...',
        'products.controls.sortNameAsc': 'الاسم: من إلى ي',
        'products.controls.sortNameDesc': 'الاسم: من ي إلى أ',
        'products.controls.sortPriceAsc': 'السعر: من الأقل إلى الأعلى',
        'products.controls.sortPriceDesc': 'السعر: من الأعلى إلى الأقل',
        'products.controls.reset': 'إعادة تعيين الأدوات',
    },
};
